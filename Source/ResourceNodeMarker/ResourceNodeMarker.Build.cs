...
public class ResourceNodeMarker : ModuleRules
{
	public ResourceNodeMarker(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        // FactoryGame plugins
        PublicDependencyModuleNames.AddRange(new string[] {
            "FactoryGame",   // Needed for AFGResourceNode and game classes
            "SML"            // SatisfactoryModLoader
        });

        // Optional extras (add if needed later)
